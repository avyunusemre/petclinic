INSERT INTO users values('user1','{bcrypt}$2a$10$Ao3B95H0FQw7svHj390N.uuDC2wtAyjjfWI3Ws/Oq3CXhlAz5NGpe',true);
INSERT INTO users values('user2','{bcrypt}$2a$10$eiuLZGC45HOJJvhjmuJx3esE0r1qNQvKfup9M3c.cgkUUozVlCAmu',true);
INSERT INTO users values('user3','{bcrypt}$2a$10$qhdVlw5R.LmMW9LVNX2Ke.LL8aJEt9wq4vCdbvBAK2BapHtTgkOKy',true);
